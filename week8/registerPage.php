    ...
    <div class="loginCard">
        <div class="header">
            ...
            <form class="registerCredentials" id="loginCredential" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
                <label for="lastName" class="reglabels">Last Name <p class="required">*</p> </label>
                <br>
                <input type="text" id="lastName" name="lastName" value placeholder="Last Name">
                <br>
                <br>
                <label for="firstName" class="reglabels">First Name <p class="required">*</p></label>
                <br>
                ...
                <br>
                <br>
                <label for="email" class="reglabels">Email <p class="required">*</p></label>
                <br>
                <input type="email" id="email" name="email" value placeholder="Email">
                <br>
                <br>
                <label for="password" class="reglabels">Password <p class="required">*</p></label>
                <br>
                <input type="password" id="password" name="password" value placeholder="Password">
                <br>
                <br>
                <label for="passwordCon" class="reglabels">Confirm Password <p class="required">*</p></label>
                <br>
